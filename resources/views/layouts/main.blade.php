...
<body>
    <div class="flex relative">
        ...
        {{-- Start Left Area --}}
            <aside id="side-bar" class="hidden flex-1 max-w-[300px] h-screen border bg-slate-200 shadow-lg md:shadow-none overflow-y-auto md:block md:static p-5 transition-all duration-300">
                <div class="space-y-5">
                    ...
                    <nav class="">
                        <ul class="mt-10 space-y-1">
                            {{-- <li class="p-2 rounded hover:bg-slate-50 transition-all duration-300">
                                ...
                                <ul class="h-0 overflow-hidden transition-all duration-300 space-y-1">
                                    <li id="administrators" class="p-2 rounded hover:bg-slate-200 transition-all duration-300">
                                        <a href="{{ route('users.administratorindex') }}" class="flex items-center gap-3">
                                            <i class="fa-solid fa-user mx-0.5 mr-1"></i>
                            ...
                            <li id="home" class="p-2 rounded hover:bg-slate-50 transition-all duration-300">
                            ...
                            <li id="users" class="p-2 rounded hover:bg-slate-50 transition-all duration-300">
                            ...
                            <li id="roles" class="p-2 rounded hover:bg-slate-50 transition-all duration-300">
        ...
        <div class="flex-1 h-screen overflow-y-auto">
            {{-- Start Top Nav Bar --}}
                <nav class="flex justify-between md:justify-end items-center gap-3 md:gap-0 bg-slate-200 p-3 sticky top-0 z-10 ">
                    <div class="block md:hidden">
    ...
    @if(request()->routeIs('home'))
        <script type="text/javascript">
            document.getElementById('home').classList.add('bg-slate-50');
            // document.getElementById('users').classList.add('bg-slate-200');
            // document.getElementById('users').parentElement.previousElementSibling.classList.add('expand');
        </script>
    @elseif(request()->routeIs('users.*'))
        <script type="text/javascript">
            document.getElementById('users').classList.add('bg-slate-50');
        </script>
    @elseif(request()->routeIs('roles.*'))
        <script type="text/javascript">
            document.getElementById('roles').classList.add('bg-slate-50');
        </script>
    @endif
